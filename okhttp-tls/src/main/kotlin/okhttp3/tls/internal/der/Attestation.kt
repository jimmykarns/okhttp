...
import okhttp3.tls.internal.der.DerHeader.Companion.TAG_CLASS_UNIVERSAL
...
object AttestationAdapters {
  ...
  internal val authorizationList = Adapters.sequence(
      "authorizationList",
      Adapters.INTEGER_AS_LONG.asSetOf().withExplicitBox(tag = 1).optional(),
      Adapters.INTEGER_AS_LONG.withExplicitBox(tag = 2).optional(),
      Adapters.INTEGER_AS_LONG.withExplicitBox(tag = 3).optional(),
      Adapters.INTEGER_AS_LONG.asSetOf().withExplicitBox(tag = 5).optional(),
      Adapters.INTEGER_AS_LONG.asSetOf().withExplicitBox(tag = 6).optional(),
      Adapters.INTEGER_AS_LONG.withExplicitBox(tag = 10).optional(),
      Adapters.INTEGER_AS_LONG.withExplicitBox(tag = 200).optional(),
      Adapters.NULL.withExplicitBox(tag = 303).optional(),
      Adapters.INTEGER_AS_LONG.withExplicitBox(tag = 400).optional(),
      Adapters.INTEGER_AS_LONG.withExplicitBox(tag = 401).optional(),
      Adapters.INTEGER_AS_LONG.withExplicitBox(tag = 402).optional(),
      Adapters.NULL.withExplicitBox(tag = 503).optional(),
      Adapters.INTEGER_AS_LONG.withExplicitBox(tag = 504).optional(),
      Adapters.INTEGER_AS_LONG.withExplicitBox(tag = 505).optional(),
      Adapters.NULL.withExplicitBox(tag = 506).optional(),
      Adapters.NULL.withExplicitBox(tag = 507).optional(),
      Adapters.NULL.withExplicitBox(tag = 508).optional(),
      Adapters.NULL.withExplicitBox(tag = 509).optional(),
      Adapters.NULL.withExplicitBox(tag = 600).optional(),
      Adapters.OCTET_STRING.withExplicitBox(tag = 601).optional(),
      Adapters.INTEGER_AS_LONG.withExplicitBox(tag = 701).optional(),
      Adapters.INTEGER_AS_LONG.withExplicitBox(tag = 702).optional(),
      Adapters.NULL.withExplicitBox(tag = 703).optional(),
      rootOfTrust.withExplicitBox(tag = 704).optional(),
      Adapters.INTEGER_AS_LONG.withExplicitBox(tag = 705).optional(),
      Adapters.INTEGER_AS_LONG.withExplicitBox(tag = 706).optional(),
      Adapters.OCTET_STRING.withExplicitBox(tag = 709).optional(),
      Adapters.OCTET_STRING.withExplicitBox(tag = 710).optional(),
      Adapters.OCTET_STRING.withExplicitBox(tag = 711).optional(),
      Adapters.OCTET_STRING.withExplicitBox(tag = 712).optional(),
      Adapters.OCTET_STRING.withExplicitBox(tag = 713).optional(),
      Adapters.OCTET_STRING.withExplicitBox(tag = 714).optional(),
      Adapters.OCTET_STRING.withExplicitBox(tag = 715).optional(),
      Adapters.OCTET_STRING.withExplicitBox(tag = 716).optional(),
      Adapters.OCTET_STRING.withExplicitBox(tag = 717).optional(),
      Adapters.INTEGER_AS_LONG.withExplicitBox(tag = 718).optional(),
      Adapters.INTEGER_AS_LONG.withExplicitBox(tag = 719).optional(),
      decompose = {
        listOf(
            it.purpose,
            it.algorithm,
  ...
  internal const val KEY_DESCRIPTION_OID = "1.3.6.1.4.1.11129.2.1.17"
}
